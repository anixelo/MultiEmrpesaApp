<x-app-layout>
    ...
    <div class="mx-auto max-w-7xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        ...
        @else
            ...
            @if(($stats['presupuestos_pendiente_revision'] ?? 0) > 0)
                <section>
                       ...
                       class="flex flex-col gap-4 rounded-3xl border border-orange-200 bg-orange-50 p-5 shadow-sm transition hover:bg-orange-100 sm:flex-row sm:items-center">
                        ...
                        <div class="flex-1">
                            <p class="font-semibold text-orange-900">
                                {{ $stats['presupuestos_pendiente_revision'] }} {{ $stats['presupuestos_pendiente_revision'] === 1 ? 'presupuesto pendiente' : 'presupuestos pendientes' }} de revisión
                            </p>
                            <p class="mt-0.5 text-sm text-orange-700">Haz clic para ver los presupuestos que necesitan tu validación.</p>
                        </div>
