    ...
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
            ...
            $cards = [
                ...
                ['label'=>'Empresas activas','value'=>$stats['active_companies'],'icon'=>'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4','color'=>'emerald'],
                ...
                ['label'=>'Total empresas','value'=>$stats['total_companies'],'icon'=>'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6','color'=>'sky'],
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                    <h2 class="font-semibold text-gray-900">Últimas empresas</h2>
                ...
                <div class="divide-y divide-gray-50">
                    ...
                    @empty
                    <p class="px-6 py-4 text-sm text-gray-400">No hay empresas aún.</p>
                    @endforelse
                </div>
            </div>
        </div>
