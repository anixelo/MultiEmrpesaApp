<x-app-layout>
    <x-slot name="header">
        <div class="flex items-start gap-3 sm:items-center">
            ...
            <div class="min-w-0">
                <h1 class="text-2xl font-bold text-slate-900">Editar plan: {{ $plan->name }}</h1>
                <p class="mt-1 truncate text-sm text-slate-500">Modifica los detalles del plan</p>
            </div>
        </div>
    </x-slot>
            ...
            <form method="POST" action="{{ route('superadmin.plans.update', $plan) }}" class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            value="{{ old('max_presupuestos', $plan->max_presupuestos ?? 0) }}"
                            min="0"
                ...
                <div>
                    ...
                    <input
                        type="number"
                        name="max_empresas"
                        value="{{ old('max_empresas', $plan->max_empresas ?? 1) }}"
                        min="0"
                ...
                <div class="space-y-4 rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    <div class="flex items-center gap-3">
                        <label class="relative inline-flex cursor-pointer items-center">
                            <input type="checkbox" name="has_notes" value="1" {{ old('has_notes', $plan->has_notes) ? 'checked' : '' }} class="peer sr-only">
                    ...
                    <div class="flex items-center gap-3">
                        <label class="relative inline-flex cursor-pointer items-center">
                            <input type="checkbox" name="has_plantillas" value="1" {{ old('has_plantillas', $plan->has_plantillas) ? 'checked' : '' }} class="peer sr-only">
                            <div class="h-6 w-10 rounded-full bg-slate-200 transition peer-checked:bg-indigo-600 peer-focus:ring-2 peer-focus:ring-indigo-200 after:absolute after:left-[2px] after:top-[2px] after:h-5 after:w-5 after:rounded-full after:border after:border-slate-300 after:bg-white after:transition-all after:content-[''] peer-checked:after:translate-x-full peer-checked:after:border-white"></div>
                        </label>
                    ...
                    <div class="flex items-center gap-3">
                        <label class="relative inline-flex cursor-pointer items-center">
                            <input type="checkbox" name="has_envio_enlace" value="1" {{ old('has_envio_enlace', $plan->has_envio_enlace) ? 'checked' : '' }} class="peer sr-only">
                            <div class="h-6 w-10 rounded-full bg-slate-200 transition peer-checked:bg-indigo-600 peer-focus:ring-2 peer-focus:ring-indigo-200 after:absolute after:left-[2px] after:top-[2px] after:h-5 after:w-5 after:rounded-full after:border after:border-slate-300 after:bg-white after:transition-all after:content-[''] peer-checked:after:translate-x-full peer-checked:after:border-white"></div>
                        </label>
                    ...
                    <div class="flex items-center gap-3">
                        <label class="relative inline-flex cursor-pointer items-center">
                            <input type="checkbox" name="has_historial_cambios" value="1" {{ old('has_historial_cambios', $plan->has_historial_cambios) ? 'checked' : '' }} class="peer sr-only">
                            <div class="h-6 w-10 rounded-full bg-slate-200 transition peer-checked:bg-indigo-600 peer-focus:ring-2 peer-focus:ring-indigo-200 after:absolute after:left-[2px] after:top-[2px] after:h-5 after:w-5 after:rounded-full after:border after:border-slate-300 after:bg-white after:transition-all after:content-[''] peer-checked:after:translate-x-full peer-checked:after:border-white"></div>
                        </label>
                    ...
                    <div class="flex items-center gap-3">
                        <label class="relative inline-flex cursor-pointer items-center">
                            <input type="checkbox" name="active" value="1" {{ old('active', $plan->active) ? 'checked' : '' }} class="peer sr-only">
                            <div class="h-6 w-10 rounded-full bg-slate-200 transition peer-checked:bg-indigo-600 peer-focus:ring-2 peer-focus:ring-indigo-200 after:absolute after:left-[2px] after:top-[2px] after:h-5 after:w-5 after:rounded-full after:border after:border-slate-300 after:bg-white after:transition-all after:content-[''] peer-checked:after:translate-x-full peer-checked:after:border-white"></div>
                        </label>
