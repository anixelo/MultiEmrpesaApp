...
<div x-data="{ webOpen: false }" class="relative">
    <button @click="webOpen = !webOpen" @click.outside="webOpen = false"
            class="flex items-center gap-1 px-3 py-2 rounded-lg text-sm font-medium transition
                   {{ request()->routeIs('superadmin.noticias.*') || request()->routeIs('superadmin.categorias.*') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }}">
        Web
    ...
    <div x-show="webOpen" x-transition
         class="absolute left-0 mt-1 w-44 bg-white rounded-xl shadow-lg border border-gray-200 py-1 z-50">
        <a href="{{ route('superadmin.noticias.index') }}"
           class="flex items-center px-4 py-2 text-sm {{ request()->routeIs('superadmin.noticias.*') ? 'text-indigo-700 font-medium' : 'text-gray-700 hover:bg-gray-50' }}">
            Noticias
        </a>
        <a href="{{ route('superadmin.categorias.index') }}"
           class="flex items-center px-4 py-2 text-sm {{ request()->routeIs('superadmin.categorias.*') ? 'text-indigo-700 font-medium' : 'text-gray-700 hover:bg-gray-50' }}">
            Categorías
        </a>
    </div>
</div>
...
<div x-data="{ webOpen: false }" class="rounded-2xl border border-slate-200 bg-slate-50/70">
    ...
    <div x-show="webOpen" x-transition class="space-y-1 px-2 pb-2">
        <a href="{{ route('superadmin.noticias.index') }}" class="block rounded-xl px-3 py-2 text-sm text-slate-600 transition hover:bg-white hover:text-slate-900">
            Noticias
        </a>
        <a href="{{ route('superadmin.categorias.index') }}" class="block rounded-xl px-3 py-2 text-sm text-slate-600 transition hover:bg-white hover:text-slate-900">
            Categorías
        </a>
    </div>
</div>
