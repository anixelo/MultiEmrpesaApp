...
<div class="bg-indigo-50 border-b border-indigo-100 py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-gray-500 mt-2">{{ trans_choice('{0} Sin contenidos|{1} :count contenido|[2,*] :count contenidos', $noticias->total()) }}</p>
    </div>
</div>
...
<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    @if($noticias->isEmpty())
        <div class="text-center py-16 text-gray-400">
            ...
            <p class="text-lg font-medium">No hay contenidos con esta etiqueta.</p>
        </div>
    @else
