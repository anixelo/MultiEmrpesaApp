    ...
    <div class="flex flex-col gap-8 lg:flex-row lg:items-start lg:justify-between">
        ...
        <div class="mt-8 overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
            <div class="border-b border-slate-100 px-6 py-4">
                <h3 class="text-base font-semibold text-slate-900">Comentarios</h3>
            </div>
            ...
            <div class="border-t border-slate-100 px-6 py-4">
                <form method="POST" action="{{ route('presupuestos.public.comentarios.store', $presupuesto->token_publico) }}" class="space-y-3">
                    @csrf
                    <div>
                        <input type="text" name="autor_nombre" placeholder="Tu nombre" required
