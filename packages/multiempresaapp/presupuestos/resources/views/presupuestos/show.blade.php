                ...
                <div x-show="showModal"
                    ...
                    <div class="bg-white rounded-2xl shadow-2xl p-6 max-w-sm w-full mx-4">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h3 class="text-base font-semibold text-gray-900">¿Marcar como enviado?</h3>
                        </div>
                        <p class="text-sm text-gray-600 mb-5">El presupuesto está en estado <strong>Borrador</strong>. ¿Deseas marcarlo como <strong>Enviado</strong>?</p>
                        <div class="flex gap-3">
                            <button type="button" @click="confirm(true)"
                                    class="flex-1 inline-flex justify-center items-center rounded-xl bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-blue-700 transition">
                                Sí, marcar como enviado
                            </button>
                            <button type="button" @click="confirm(false)"
                                    class="flex-1 inline-flex justify-center items-center rounded-xl bg-gray-100 px-4 py-2.5 text-sm font-semibold text-gray-700 hover:bg-gray-200 transition">
                                No, continuar
                            </button>
                        </div>
                    </div>
